       ...
       <div className="glass-card p-10 lg:p-12 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-10">
             <div className="flex items-center gap-5">
                ...
                <div>
                   ...
                   <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.3em] mt-0.5">Operational Status Update</p>
                </div>
             </div>
             {isSubmitted && (
          ...
          <form className="space-y-10" onSubmit={handleSubmit}>
             <div className="space-y-4">
                ...
                <textarea 
                  placeholder="DETAILED STATUS REPORT..." 
                  value={description}
             ...
             <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="relative group h-40 border-2 border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center bg-white/[0.02] hover:bg-brand-primary/5 hover:border-brand-primary/30 transition-all">
                      ...
                      <p className="text-[10px] font-black text-slate-500 uppercase">Select Assets</p>
                   </div>
             ...
             <button type="submit" disabled={isUploading} className={`w-full py-6 bg-brand-primary text-white rounded-3xl font-black uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_20px_50px_rgba(99,102,241,0.2)] ${isUploading ? 'opacity-50' : ''}`}>
                {isUploading ? uploadProgress : 'Submit Daily Report'}
             </button>
          </form>
       </div>

       {/* ── PANEL 2: FINAL SUBMISSION REPORT ── */}
          ...
          <div className="flex items-center justify-between mb-10">
             <div className="flex items-center gap-5">
                ...
                <div>
                   ...
                   <p className="text-[9px] font-black text-emerald-500/70 uppercase tracking-[0.3em] mt-0.5">Project Completion Delivery</p>
                </div>
             </div>
             {activeProject.status === 'Completed' && (
               <span className="px-4 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-400 text-[9px] font-black uppercase tracking-widest">Delivered</span>
             )}
          </div>
          <div className="space-y-6">
             <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Final Delivery Description</label>
                <textarea
                  placeholder="DESCRIBE THE FINAL DELIVERY..."
             ...
             <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Final Project Archive <span className="text-slate-600">(ZIP)</span></label>
             ...
             <div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl text-center">
                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">
                   Click <span className="text-emerald-400 font-black">Completed</span> in the operational briefing panel to submit this final delivery
                </p>
             </div>
          </div>
       </div>
