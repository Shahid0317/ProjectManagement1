    ...
    <div className="glass-card p-10 sm:p-12 relative overflow-hidden group">
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl font-display font-bold mb-4 tracking-tighter text-gradient">
          {isLogin ? 'Command Center' : 'New Employee'}
        </h2>
        ...
        <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.3em] leading-loose">
          {isLogin ? 'Authenticating Authority Session' : 'Initializing Personnel Profile'}
        </p>
      </div>
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        {!isLogin && (
          <div className="space-y-2 animate-fadeIn">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-primary ml-1">Codename</label>
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-primary ml-1">Report ID</label>
          <div className="relative group">
        ...
        {/* Password */}
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-primary ml-1">Access Protocol</label>
          <div className="relative group">
        ...
        >
          <span>{isLogin ? 'Initiate Link' : 'Register Protocol'}</span>
      ...
      <div className="text-center mt-12 pt-8 border-t border-white/5">
        <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest">
          {isLogin ? "New Personnel?" : "Existing Employee?"}
          <button 
            type="button" 
            onClick={toggleAuthMode} 
            className="text-brand-primary ml-2 hover:text-white transition-colors underline underline-offset-4"
          >
            {isLogin ? 'Request Access' : 'Return to Node'}
          </button>
        </p>
      </div>
    </div>
